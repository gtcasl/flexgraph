...
using ch_block_t = ch_bit<aal::aal_qpi0::cdata_width>;
...
__struct (ch_hwcntrs_t, (
  (ch_pe_hwcntrs_t) PE0,
  (ch_pe_hwcntrs_t) PE1,
  (ch_bit<20>) a_partitions_stalls,
  (ch_bit<20>) vcache_hits,
  (ch_bit<20>) vcache_stalls
));
